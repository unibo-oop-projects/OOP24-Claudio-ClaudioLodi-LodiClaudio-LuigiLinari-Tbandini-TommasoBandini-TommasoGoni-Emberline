 ...
 public class Coordinate2D {
      ...
      */
     public static final Coordinate2D ZERO = new Coordinate2D(0.0, 0.0);
      ...
      * @since JavaFX 8.0
      */
     public Coordinate2D add(Coordinate2D point) {
      ...
      * @since JavaFX 8.0
      */
     public Coordinate2D subtract(double x, double y) {
         return new Coordinate2D(
                 getX() - x,
                 getY() - y);
     }
      ...
      * @since JavaFX 8.0
      */
     public Coordinate2D subtract(Coordinate2D point) {
      ...
      * @since JavaFX 8.0
      */
     public Coordinate2D midpoint(double x, double y) {
         return new Coordinate2D(
                 x + (getX() - x) / 2.0,
                 y + (getY() - y) / 2.0);
     }
      ...
      * @since JavaFX 8.0
      */
     public Coordinate2D midpoint(Coordinate2D point) {
      ...
      * @since JavaFX 8.0
      */
     public double angle(Coordinate2D point) {
      ...
      * @since JavaFX 8.0
      */
     public double angle(Coordinate2D p1, Coordinate2D p2) {
         final double x = getX();
         final double y = getY();
      ...
      * @since JavaFX 8.0
      */
     public double dotProduct(Coordinate2D vector) {
      ...
      * @since 13
      */
     public Coordinate2D interpolate(Coordinate2D endValue, double t) {
